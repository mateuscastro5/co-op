                ...
                <div className="w-[493px] md:w-[637px] h-[989px] flex flex-col bg-white rounded-[10px] pt-12">
                    ...
                    <form className="flex flex-col pl-10 pr-10 pt-12 pb-12">
                        ...
                        <p className="flex flex-col items-start pt-10">
                            ...
                            <input type="email" placeholder='Digite aqui...' required className='pl-4 text-[#212c42]/80 text-base font-light font-Jost w-[395.48px] md:w-[556px]  h-[55.32px] bg-[#e64eeb]/20 rounded-md border border-[#e64eeb]'/>
                        </p>
                        <p className="flex flex-col items-start pt-10">
                            <label className='text-fundo text-xl font-light font-Jost'>Telefone</label>
                            <input type="number" placeholder='Digite aqui...' required className='pl-4 text-[#212c42]/80 text-base font-light font-Jost w-[395.48px] md:w-[556px]  h-[55.32px] bg-[#e64eeb]/20 rounded-md border border-[#e64eeb]'/>
                        </p>
